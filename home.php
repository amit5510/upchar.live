...
<div class="container">
<div class="row">
                        <aside class="col-md-3 logocont"><a href="https://www.upchar.shop/" class="careplus-logo"><img src="images/upchar-logo.png" style="height: 155px;" alt=""></a></aside>
...
<div class="container text-right menucont">
  ...
  <a href="#" class="showPartners"><button type="button" class="btn topmenu">Partner</button></a>
    <a href="https://www.upchar.shop/signup" class="showPartners"><button type="button" class="btn topmenu"><i class="fas fa-user"></i> Login / <i class="fas fa-sign-in-alt"></i> Sign Up</button>
</div>
                    ...
                    <div class="row">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                     <!-- <ul class="nav navbar-nav" style="display: table;content: " ";">
                                        <li class="active"><a href="https://www.upchar.shop/">Home</a></li>
                                        <li><a href="https://www.upchar.shop/search?location=&amp;city=&amp;keyword=&amp;spl=">Appointment</a>
                                        ...
                                        <li><a href="#">Blogs</a>
                                         ...
                                         <li class="careplus-megamenu-li"><a href="https://www.upchar.shop/doctors">Our Doctor</a></li>
                                                ...
                                                <li class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <a href="#" class="careplus-thumbnail">
                                                            <img src="https://www.upchar.shop/extra-images/megamenu-frame.jpg" alt="">
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
                             ...
                             <div class="careplus-cart-box"> <p>No products in the cart.</p> </div>
                                   ...
                                   <!--- <li>
                                      <div class="login">               
                                        <a href="https://www.upchar.shop/login">Login </a>
                                        <a href="https://www.upchar.shop/signup">/ Sign Up</a>                  
...
<form action="https://www.upchar.shop/search" method="GET">
                <div class="box-form">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="careplus-banner-wrap">
                                        <h1><span>You Canâ€™t</span>Always Be There<span>But We Can help</span></h1>
										<p>Book your Doctor/Hospital/pathology/medicin online Appointment 24/7 on call support</p>
									   <p>Upcharâ€™s relevance algorithm for the Practitioners is a fully automated system that lists the Practitioners, their profile and information regarding their Practice on its Website</p>
                                        <div class="clearfix"></div>
                ...
                <div class="container">
                    ...
                    <!--
                            <div class="careplus-team careplus-team-medium">
                                <ul class="row">
                                    <li class="col-md-3">
                                        <figure><a href=""><img src="img1.jpg" alt=""></a>
                                            <figcaption>
                                                ...
                                                <div class="careplus-team-medium-text">
                                                    ...
                                                    <span>Dental Hygienist</span>
                                                    <img src="doctor.jpg" style="width: 199px;padding-top: 14px;">
                                                    <p>Upcharâ€™s relevance algorithm for the Practitioners is a fully automated system that lists the Practitioners, their profile and information regarding their Practice on its Website</p>
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="img2.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="img3.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                    ...
                                    <li class="col-md-3">
                                        <figure><a href="team-detail.php"><img src="img4.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
...
<div class="col-xs-12">
                                        ...
                                        <figure><a href=""><img src="img1.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    ...
                                                    <span>MBBS, MD (Cardio)Pediatrics</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.php">Dr Sunil Kushwaha </a></h5>
                                                    <span>MBBS, MD (Cardio)Pediatrics</span>
                                                    <img src="img1.jpg" style="height: 184px;padding-top: 10px;">
                                                    <p>Upcharâ€™s Practitioners is a fully automated system that lists the Practitioners, their profile and information regarding their Practice on its Website</p>
  ...
  <li class="col-md-3">
                                        <figure><a href=""><img src="img2.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.php">Dr P. K. Verma</a></h5>
                                                    <span>MS(ortho)20 years experience Orthopedic</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.php">Dr P. K. Verma</a></h5>
                                                    <span>MS(ortho)20 years experience Orthopedic</span>
                                                    <img src="img2.jpg" style="height: 184px;padding-top: 10px;">
                                                    <p>Upcharâ€™s Practitioners is a fully automated system that lists the Practitioners, their profile and information regarding their Practice on its Website</p>
                                     ...
                                     <li class="col-md-3">
                                        <figure><a href=""><img src="img3.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.php">Dr. shahnaj khatoon</a></h5>
                                                    <span>ENT</span>
                                                </div>
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.php">Dr. shahnaj khatoon</a></h5>
                                                    <span>Dental Hygienist</span>
                                                    <img src="img3.jpg" style="height: 184px;padding-top: 10px;">
                                                    <p>Upcharâ€™s Practitioners is a fully automated system that lists the Practitioners, their profile and information regarding their Practice on its Website</p>
                    ...
                    <div class="row">
                        <!--// Widget Contact Info \\-->
                         ...
                         <aside class="col-md-4 widget widget_contact_info">
                            ...
                            <p>GYANTECH International Private Limited (â€œUPCHARRâ€) is the author and publisher of the internet resource http://www.upchar.shop and the mobile application â€˜Upcharâ€™ (together, â€œWebsiteâ€). Upcharr owns and operates the services provided through the Website..
                        ...
                        <aside class="col-md-4 widget widget_useful_link">
                            ...
                            <ul>
                                ...
                                <li><a href="https://www.upchar.shop/search?location=&city=&keyword=&spl=">Appointment</a></li>-->
                            </ul>
                        </aside>
                        <!--// Widget Useful Link \\-->
                        <!--// Widget Newsletter \\-->
                        <aside class="col-md-4 widget widget_contact_info">
                            ...
                            <ul>
                                ...
                                <li>
                                    <h6>Mail Us At:</h6>
                                    <a href="mailto:yourdomain@name.com">hello@upchar.shop - info@upchar.shop</a>
                                </li>
                                <li>
                                    <h6>Our Location:</h6>
...
$(document).ready(function(){
  ...
  $(".showPartners").mouseout(function(){
