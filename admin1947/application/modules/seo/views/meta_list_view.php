        ...
        <section class="content">
          <div class="container bg-3 ">  
            <div class="row text-">
              ...
              <?php echo form_open("seo/meta/index",'class="form-horizontal formbody" id="search_form" method="get"');  ?>
				<div class="row mainheadlinefirstrow">
					<div class="col-md-12 mainheadlinefirst">Basic Filter
					<a  href="<?php echo base_url();?>seo/meta/add" class="btn btn-info" style="float:right;" id="submit" >Add Meta</a>
					</div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
                        <input type="text" class="form-control input-sm"  name="meta_title" value="<?php echo $this->input->get_post('meta_title');?>">
                      </div>
                      ...
                      <div class="col-sm-3">
						...
						<?php 
                         if($this->input->get_post('meta_title')!='' )
                          { 
                            echo anchor("seo/meta/index/",'<span>Clear Search</span>');    
                          } 
                        ?>
                      </div>
                    </div>
             ...
             <?php echo form_close();?>
              <h4 style="font-weight:600;margin-bottom:20px;"><?php echo $heading_title;?></h4>
              ...
              <table class="table table-hover table-bordered table-bordered" id='exportTable' style="border:none;">
                <thead>
                  <tr>
                    ...
                    <th class="tableheaddata">URL</th>
                    <th class="tableheaddata">Title</th>
                    <th class="tableheaddata">Description</th>
                    <th class="tableheaddata">Keyword</th>
                ...
                <tbody id="tviewtablebody">
                  ...
                  {	
                    echo"<tr>";
                    echo"<td>".$p->meta_id."</td>";
                    echo"<td> https://www.upchar.shop/".$p->page_url."</td>";
                    echo"<td>".$p->meta_title."</td>";
                    echo"<td>".$p->meta_description."</td>";
                    echo"<td>".$p->meta_keyword."</td>";
                    ?>
					<td><?php if($p->status=='0'){ echo '<span style="color:red;">De-Active</span>'; } else{ echo '<span style="color:green;">Active</span>'; } ?></td>
                   <?php 
					echo "<td><a href='".base_url()."seo/meta/edit/".$p->meta_id."' style='color:green'><span class='glyphicon glyphicon-edit'></span></a></td>";
                    echo"</tr>";
                    echo"</tr>";
                  }
                  ?>
