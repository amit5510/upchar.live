...
class Azad_lib {
	...
	{ 
		...
		$setting->smtpserver ='mail.upchar.shop';
		$setting->smtpport ='465';
		$setting->smtpuser ='upcharr@upchar.shop';
		$setting->smtppass ='swati@123';//'admin123456';
		$setting->fromemail ='upcharr@upchar.shop';
		if(strlen($body) < 30)
		$templateid=$body;
	...
	{ 
		...
		$setting->smtpport ='465';
		$setting->smtpuser ='info@upchar.shop';
		$setting->smtppass ='}A^(B{OVJ=KY';
		$setting->fromemail ='info@upchar.shop';
		if(strlen($body) < 30)
		$templateid=$body;
