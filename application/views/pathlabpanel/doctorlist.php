<?php include ("assets/includes/header_pathlab.php"); ?>
                    ...
                    <div class="pag_cstm_panel">
                        ...
                        <div class="pag_cstm_panel_panel_ontent p-t-0">
							...
							<!--<a href='<?=base_url();?>hospitalpanel/adddoctor'><button type='submit' name='submit' class="btn btn-primary pull-right">Add Doctor</button></a>--></h4>
								...
								<?php 																foreach($doctorlist as $d){ 																?>		<div class="col-sm-9 col-xs-12 box_sh_bg">
                    <div class="">
                        ...
                        <div class="col-sm-7 col-xs-10">
                            ...
                            <div class="hosp_name">
                              ...
                              <!--  <ul> 
                                ...
                                <p>â€³He is very friendly, approachable and efficient doctor. â€³ â€” Manish Shewani, visited for kidney stone removal</p>
                        ...
                        <div class="col-sm-3 padd0">
							...
							<?php if($d->p_status==null){ ?>
                             <form action='<?=base_url();?>pathlabpanel/linkdoctor' method='POST'>
							...
							<button type="submit" class="btn-lg view_profile getappointment" data-upchar-did='<?=$d->id;?>' >Link To Hospital</button>
							</form>
							<?php }else{
							...
							<?php }else{ ?>
							<form action='<?=base_url();?>pathlabpanel/unlinkdoctor' method='POST'>
							  <input type="hidden" name="link" value='1' id='link' class="form-control">	
                                  <input type="hidden" name="link2" value='<?=$d->id;?>' id='link2' class="form-control">	
                                  
							<button type="submit" class="btn-lg view_profile " style='background:red;' >UnLink Doctor</button>
							</form>
							...
							<?php } ?>
                               ...
                               <!-- <div class="col-sm-5 hoslist_he mrgt30">
                                        ...
                                        <p>
                                            ...
                                            This information helps us perform critical checks to ensure that only licensed and genuine medical practitioners are listed on Upchaar . Your profile will get a â€œVerifiedâ€ badge on verification. Doctors with verified profiles get 95% more patient views on Upchaar.</p>
	...
	<link rel="stylesheet" type="text/css"  href='https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css'>
		...
		<link rel="stylesheet" type="text/css"  href='https://www.upchar.shop/css/coustm.css'>		<style>		.docimg img{			width:120px;		}		</style>
		<script>
