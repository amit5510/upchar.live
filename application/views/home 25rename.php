...
<div class="container">
<div class="row">
                        <aside class="col-md-3 logocont"><a href="https://www.upchar.shop/" class="careplus-logo"><img src="upchar-logo.png" style="height: 155px;" alt=""></a></aside>
...
<div class="container text-right menucont">
  ...
  <button type="button" class="btn topmenu">Partner</button>
    <button type="button" class="btn topmenu"><i class="fas fa-user"></i> Login / <i class="fas fa-sign-in-alt"></i> Sign Up</button>
</div>
...
<div class="col-xs-12">
  ...
  <li class="col-md-3">
                                     ...
                                     <li class="col-md-3">
                                        <figure><a href=""><img src="img4.jpg" alt=""></a>
                                            <figcaption>
                                                <div class="careplus-team-medium-info">
                                                    <h5><a href="team-detail.php">Dr. Leslie Gross</a></h5>
                                                    <span>Surgery Specialist</span>
                                                ...
                                                <div class="careplus-team-medium-text">
                                                    <h5><a href="team-detail.php">Dr. Leslie Gross</a></h5>
                                                    <span>Surgery Specialist</span>
                                                    <img src="img4.jpg" style="height: 184px;padding-top: 10px;">
                                                    <p>Lorem ipsum dolor sit ameta ectetur adipiscing elit. Sed ementum nulla, eu pla</p>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="careplus-blog careplus-blog-modern">
                                <ul class="row">
                                        ...
                                        <li class="col-md-3">
                                        <figure ><a href="blog-detail.php"><img src="blog-modern-img2.jpg" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                    ...
                                    <li class="col-md-3">
                                        ...
                                        <figure><a href="blog-detail.php"><img src="blog-modern-img3.jpg" alt=""><span><i class="fa fa-link"></i><small></small></span></a>
                                           <!--    <time datetime="2008-02-14 20:00">21 AUG</time>-->
                                        </figure>
                                        <div class="careplus-blog-modern-text text-center">
