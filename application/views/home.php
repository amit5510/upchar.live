                                 ...
                                 <li class="col-md-4">
                                        ...
                                        <div class="col-md-9">
                                             <h5>Looking For Doctors </h5>
                                              ...
                                              <a href="https://www.upchar.shop/search?location=&city=&keyword=&spl=" class="BOOKBTN"><i class="fa fa-search" style="margin-right:6px;" aria-hidden="true"></i> Doctors</a>
                                        </div>
                                         </div>
                                    ...
                                    <li class="col-md-4">
                                        ...
                                        <div class="col-md-9">
                                             <h5>Looking For Hospital </h5>
                                              ...
                                              <a href="https://www.upchar.shop/hospitallist" class="BOOKBTN"><i class="fa fa-search" style="margin-right:6px;" aria-hidden="true"></i> Hospital</a>
                                        </div>
                                         </div>
