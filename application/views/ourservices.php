                        ...
                        <div class="col-md-12">
                            ...
                            <div class="careplus-blog careplus-blog-modern">
                                <ul class="row">
                                        ...
                                        <li class="col-md-3">
                                        <figure ><a href='<?=base_url();?>hospital-login'><img src="https://www.upchar.shop/images/Hospital.jpg" alt=""><span><i class="fa fa-link" style="padding:5px 0px;"></i><small></small></span></a>
                                    ...
                                    <li class="col-md-3">
                                        <figure ><a href="blog-detail.php"><img src="https://www.upchar.shop/images/blog-modern-img3.jpg" alt=""><span><i class="fa fa-link" style="padding:5px 0px;"></i><small></small></span></a>
                                            <!--    <time datetime="2008-02-14 20:00">21 AUG</time>-->
                                        </figure>
                                        <div class="careplus-blog-modern-text text-center">
                                    ...
                                    <li class="col-md-3">
                                        ...
                                        <figure><a href="blog-detail.php"><img src="https://www.upchar.shop/images/3d-printed-pharmaceuticals-header_kss.jpg" alt=""><span><i class="fa fa-link" style="padding:5px 0px;"></i><small></small></span></a>
                                           <!--    <time datetime="2008-02-14 20:00">21 AUG</time>-->
                                        </figure>
                                        <div class="careplus-blog-modern-text text-center">
                                    ...
                                    <li class="col-md-3">
                                        ...
                                        <figure><a href='<?=base_url();?>doctor-login'><img src="https://www.upchar.shop/images/blog-modern-img2.jpg" alt=""><span><i class="fa fa-link" style="padding:5px 0px;"></i><small></small></span></a>
                                          <!--    <time datetime="2008-02-14 20:00">21 AUG</time>-->
                                        </figure>
                                          <div class="careplus-blog-modern-text text-center">
