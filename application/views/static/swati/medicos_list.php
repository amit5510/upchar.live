...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   <link href="https://www.upchar.shop/dev/css/datepicker.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/bootstrap.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/font-awesome.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/flaticon.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/slick-slider.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/fancybox.css" rel="stylesheet">
     <link href="https://www.upchar.shop/dev/css/coustm.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/style.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/color.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/style.css" rel="stylesheet">
    <link href="https://www.upchar.shop/dev/css/responsive.css" rel="stylesheet">
...
.careplus-user-list li {
 ...
 <header id="careplus-header" class="careplus-header-one">
            ...
            <div class="careplus-main-header">
                <div class="container">
                    <div class="row">
                        <aside class="col-md-3"><a href="https://www.upchar.shop/dev/" class="careplus-logo"><img src="https://www.upchar.shop/dev/images/logo.png" alt=""></a></aside>
                        <aside class="col-md-9">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="https://www.upchar.shop/dev/User/logout"><span>Logout</span></a></li>
                            </ul>
                                ...
                                <nav class="navbar navbar-default">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                      <ul class="nav navbar-nav">
                                        <li class="active"><a href="https://www.upchar.shop/dev/">Home</a></li>
                                        <li><a href="#">Gallery</a>
                                        ...
                                        -->
                                         <li class="careplus-megamenu-li"><a href="https://www.upchar.shop/dev/doctors">Our Doctor</a></li>
                                                ...
                                                <li class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <a href="#" class="careplus-thumbnail">
                                                            <img src="https://www.upchar.shop/dev/extra-images/megamenu-frame.jpg" alt="">
                                                        </a>
                                                    </div>
                                                </li>
                                            </ul>
...
<div class="container-fluid">
            <div class="row">
			<form action='https://www.upchar.shop/dev/search' method='GET'>
                <div class="box-form">
...
<li class=""><a href="milestone.php"><i class="fa fa-user-md" aria-hidden="true"></i><span>Profile</span> </a> </li>
                    ...
                    <div class="">
						...
						<img src="https://www.upchar.shop/dev/images/logo-doctores.png" class="img-responsive" alt="">
                        </div>

                        <div class="col-sm-7 col-xs-10">
                            <div class="doc_nam">
                                <span>Batra Medicos </span>
                                <ul>
                                    <li>Year Established : 1982</li>
                        ...
                        <div class="col-sm-3 padd0">
                            <ul class="add_list">
                                ...
                                <li><i class="fa fa-map-marker"></i>
                                    <span>3213-A, Bahadurgarh Road, Delhi - 110006</span></li>
                        ...
                        <div class="col-sm-12 padd0">
                            ...
                            <a href="#" class="view_profile"> Upload Perpription </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <aside class="col-md-4 widget widget_contact_info">
                            <a href="index.html" class="footer-logo"><img src="https://www.upchar.shop/dev/images/footer-logo.png" alt=""></a>
...
<div class="modal fade" id="myModal">
 ...
 <form method='post' action='https://www.upchar.shop/dev/home/bookappointment' id='app_conf_form'>
...
<script>
    ...
    <script type="text/javascript" src="https://www.upchar.shop/dev/css/bootstrap-datepicker.js"></script>
   <!-- <script type="text/javascript" src="script/jquery.js"></script>
		...
		$.ajax({			
			...
			success: function( response ) {			
				...
				if(response.status=='success'){					
					window.location="https://www.upchar.shop/dev/verifymobile";				
				}				
	...
	$('#loginform').submit(function(e) {		
		...
		$.ajax({			
			...
			success: function( response ) {				 
				...
				if(response.status=='success'){
				//location.reload();	
				window.location="https://www.upchar.shop/dev/";		
				}				
	...
	$('#forgotform').submit(function(e) {		
		...
		$.ajax({			
			...
			success: function( response ) {				 
				...
				if(response.status=='success'){
				//window.location="https://www.upchar.shop/dev/";	
				//window.location="https://www.upchar.shop/dev/verifymobileforgot";	
				$('#forgotform').hide();
				$('#forgototpform').show();
				}else{					
					alert('opps'+response.msg);				
	...
	$('#forgotnewpassform').submit(function(e) {		
		...
		success: function( response ) {				
			response = JSON.parse(response);				
			if(response.status=='success'){										
				window.location="https://www.upchar.shop/dev/login";
				//window.location="https://www.upchar.shop/dev/";
				//$('#forgototpform').hide();
				//$('#forgotnewpassform').show();
			}else if(response.status=='failed'){					
	...
	$('body').on('click','.getappointment',function(e) {		
		...
		$('#app_conf_pop_institute').html('');
		 ...
		 $.ajax({
			  ...
			  //data: {id : menuId},
			  //dataType: "html"
              url: "https://www.upchar.shop/dev/home/app_conf_pop_doctor?doctor="+did,
		...
		$.ajax({
			 ...
			 // data: {id : menuId},
			  //dataType: "html"
              url: "https://www.upchar.shop/dev/home/app_conf_pop_date?doctor="+did,
              success: function( data ) {
	 ...
	 $('body').on('change','#app_conf_pop_date',function(e) {		
		...
		$('#app_conf_pop_institute').html('');
		 ...
		 $.ajax({
			  type: "POST",
              url: "https://www.upchar.shop/dev/home/app_conf_pop_time?doctor="+did+"&date="+date,
              success: function( data ) {
	...
	$('body').on('change','#app_conf_pop_time',function(e) {		
		//e.preventDefault(e);
		 ...
		 $.ajax({
			  type: "POST",
              url: "https://www.upchar.shop/dev/home/app_conf_pop_institute?doctor="+did+"&date="+date+"&time="+time,
              success: function( data ) {
	...
	$('body').on('click','#app_conf_otp_submit',function(e) {		
		...
		//send otp
		  $.ajax({
			  type: "POST",
              url: "https://www.upchar.shop/dev/home/app_conf_pop_otpgen",
			  data: 'mobile=' + mobile, 
              success: function( data ) {
				  //$('#app_conf_pop_institute').html(data);
			  }
  ...
  <script type="text/javascript"> 
        ...
        $(function() {
			/* $( "#hint" ).autocomplete({
             ...
             $( "#hint" ).autocomplete({
                ...
                source: function( request, response ) {
                    $.ajax({
                        url: "https://www.upchar.shop/dev/gethint",
                        dataType: "json",
                        data: {
                            q: request.term
                        },
			...
			$( "#hintcity" ).autocomplete({
                ...
                source: function( request, response ) {
                    $.ajax({
                        url: "https://www.upchar.shop/dev/gethintcity",
                        dataType: "json",
                        data: {
                            q: request.term
                        },
